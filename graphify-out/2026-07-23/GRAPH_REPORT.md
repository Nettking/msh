...
Cohesion: 0.12
Nodes (29): _active_runtime_namespace(), _artifact_index_key(), _best_artifact_for_machine_day(), _cached_playback_selection_index(), _entry_machine_days(), _entry_machines(), _namespace_from_auto_session_id(), playback_artifact_runtime_preference() (+21 more)
...
### Community 41 - "operator_support_model.py"
Cohesion: 0.15
Nodes (10): ActionRisk, AlternativeAction, CauseHypothesis, EvidenceItem, _now_utc(), OperatorConfirmation, ProblemObservation, Any (+2 more)
...
Cohesion: 0.22
Nodes (11): first_part(), learning(), machine_notes(), quality_outcomes(), save_quality_outcome(), _source_inventory(), _now_utc(), Any (+3 more)
...
Cohesion: 0.18
Nodes (14): cached_cache_status(), Return cache status with a short TTL to protect request hot paths.      ``cach, load_cached_playback_frame_for_machine_day(), _playback_index_entry_for_path(), Path, Mirror automatic workflow session-id namespace sanitization., Return true when session naming clearly links a session to the active run., Load a playback-ready timeline from the telemetry cache for one machine/day. (+6 more)

### Community 63 - "OperatorConfirmationService"
Cohesion: 0.28
Nodes (7): assist(), confirm_assist_action(), _now_utc(), OperatorConfirmationService, Any, Path, _text()
...
### Community 68 - "OperatorSupportService"
Cohesion: 0.33
Nodes (5): action_requires_confirmation(), SupportCard, _note_text(), OperatorSupportService, Any
