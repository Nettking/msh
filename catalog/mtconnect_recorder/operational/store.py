            ...
            for cycle in sorted(cycles, key=lambda item: (item.device_key, item.start_sequence, item.cycle_id)):
                ...
                connection.execute(
                    ...
                    (
                        ...
                        int(cycle.start_boundary.confidence.value == "PARTIAL"),
                        int(cycle.end_boundary.confidence.value == "PARTIAL"),
            ...
            for episode in sorted(
                ...
                connection.execute(
                    ...
                    (
                        ...
                        int(episode.start_boundary.confidence.value == "PARTIAL"),
                        int(episode.end_boundary.confidence.value == "PARTIAL"),
                        _json(context),
