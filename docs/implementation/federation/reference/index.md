...
| Entry point | [Current FCP architecture](../../../architecture.md) |
...
- [FCP architecture](../../../architecture.md) — product model, components, authority boundaries, storage, jobs, data flow, persistence, and acceptance.
